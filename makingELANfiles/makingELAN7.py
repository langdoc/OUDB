...
#zum Testen von ipa only + ipa audio
...
for singleText in listDocInfo:
    ...
    #flex only
        # if idText not in audiosList and flex == 1:
            ...
            # for x in range(0, tsCounter+2):
                # timeSlot = SubElement(timeOrder, 'TIME_SLOT', TIME_SLOT_ID=str(tsCounterIntern), TIME_VALUE=str(timeValueCounter)) #TIME_VALUE wieder reingetan
                # tsCounterIntern += 1
                # timeValueCounter += 400 #wieder reingetan

            # tierRef = SubElement(root, 'TIER', LINGUISTIC_TYPE_REF="refT", TIER_ID="ref@ABC")
            # annotation = SubElement(tierRef, 'ANNOTATION')
            # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1='0', TIME_SLOT_REF2='1')
            # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
            # annotationValue.text = str(idText)
            # annotationIDcounter += 1
            ...
            # for id in resultIdSentences:
                ...
                # annotation = SubElement(tierOrth, 'ANNOTATION')
                # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(dictIDtokens[minIDtoken][0]), TIME_SLOT_REF2=str(dictIDtokens[maxIDtoken][1]))
                # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
            ...
            # for key, value in dictIDtokens.items():
                ...
                # annotation = SubElement(tierWord, 'ANNOTATION')
                # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]), TIME_SLOT_REF2=str(value[1]))
                # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
            ...
            # def makingMorphLemmaPosGloss(columnName, tier, annotationIDcounter):
                # for key, value in dictIDtokens.items():
                    ...
                    # if result0[0] != '':
                        ...
                        # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]), TIME_SLOT_REF2=str(value[0]+1))
                        # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
                    ...
                    # if result1[0] != '':
                        # annotation = SubElement(tier, 'ANNOTATION')
                        # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]+1), TIME_SLOT_REF2=str(value[0]+2))
                        # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
                    ...
                    # if result2[0] != '':
                        # annotation = SubElement(tier, 'ANNOTATION')
                        # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]+2), TIME_SLOT_REF2=str(value[0]+3))
                        # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
                    ...
                    # if result3[0] != '':
                        # annotation = SubElement(tier, 'ANNOTATION')
                        # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]+3), TIME_SLOT_REF2=str(value[0]+4))
                        # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
                    ...
                    # if result4[0] != '':
                        # annotation = SubElement(tier, 'ANNOTATION')
                        # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]+4), TIME_SLOT_REF2=str(value[0]+5))
                        # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
                    ...
                    # if result5[0] != '':
                        # annotation = SubElement(tier, 'ANNOTATION')
                        # alignableAnnotation = SubElement(annotation, 'ALIGNABLE_ANNOTATION', ANNOTATION_ID='a'+str(annotationIDcounter), TIME_SLOT_REF1=str(value[0]+5), TIME_SLOT_REF2=str(value[1]))
                        # annotationValue = SubElement(alignableAnnotation, 'ANNOTATION_VALUE')
    ...
    if idText in audiosList and flex == 0:
        ...
        # if idText not in audiosList and flex == 1:
            ...
            # outputFile.write(strippedNewLine)
            # outputFile.close()
    # else:# idText in audioList and flex == 1
